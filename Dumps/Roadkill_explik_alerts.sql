...
--
-- Table structure for table `explik_alerts`
--
...
CREATE TABLE `explik_alerts` (
  ...
  `Ilk` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `explik_alerts`
--

LOCK TABLES `explik_alerts` WRITE;
/*!40000 ALTER TABLE `explik_alerts` DISABLE KEYS */;
/*!40000 ALTER TABLE `explik_alerts` ENABLE KEYS */;
UNLOCK TABLES;
