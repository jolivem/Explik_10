...
namespace Roadkill.Tests.Unit
{
	...
	public class FromEntityTests
	{
		...
		public void ToPage_ShouldFillCorrectProperties()
		{
			...
			entity.PublishedOn = DateTime.UtcNow.AddYears(1);
			...
			Assert.That(page.PublishedOn, Is.EqualTo(entity.PublishedOn));
		...
		public void ToPageList_ShouldContainValidList()
		{
			...
			entity1.PublishedOn = DateTime.UtcNow.AddYears(1);
			...
			entity2.PublishedOn = DateTime.UtcNow.AddYears(2);
			entity2.Tags = "tag2";
			...
			entity3.PublishedOn = DateTime.UtcNow.AddYears(3);
