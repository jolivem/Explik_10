...
$sql = 'SELECT * FROM explik_pages WHERE IsLocked="0" AND IsControlled="1" AND IsRejected="0" AND CompetitionId="2"';
//error_log("bloub", 0);
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		$nbrating = rand(48,52);
		$totalrating = rand(150,200);
		//error_log( "nbview: " . $row["NbView"] . "n: " . $n, 0);
		$sql1="UPDATE explik_pages SET NbRating='".$nbrating."', TotalRating='".$totalrating."' WHERE Id='".$row["Id"]."'";
