...
namespace Roadkill.Core.Localization
{
	...
	public class LocalizationTokens
	{
		...
		private static readonly string MENU_TOKENS_REPLACEMENT = "<br/>%mainpage%<br/>%allpages%<br/>%allnewpages%<br/>%allnewcomments%<br/>%mypages%<br/>%mycourses%<br/>%alerts%<br/>%newpage%<br/>%competitions%<br/>%categories%<br/>%sitesettings%.";
