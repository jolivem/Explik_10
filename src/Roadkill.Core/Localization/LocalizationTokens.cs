...
namespace Roadkill.Core.Localization
{
	...
	public class LocalizationTokens
	{
		...
		private static readonly string MENU_TOKENS_REPLACEMENT = "<br/>%mainpage%<br/>%categories%<br/>%allpages%<br/>%allnewpages%<br/>%allnewcomments%<br/>%mypages%<br/>%alerts%<br/>%newpage%<br/>%competitions%<br/>%sitesettings%.";
