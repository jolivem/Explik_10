...
namespace Roadkill.Core.MyLucene
{
    ...
    */
    public sealed class MyFrenchStemFilter : TokenFilter
    {

        /*
         * The actual token in the input stream.
         */
        private MyFrenchStemmer stemmer = null;
        private ISet<string> exclusions = null;

        private ITermAttribute termAtt;

        public MyFrenchStemFilter(TokenStream _in)
            : base(_in)
        {

            stemmer = new MyFrenchStemmer();
            termAtt = AddAttribute<ITermAttribute>();
        }


        public MyFrenchStemFilter(TokenStream _in, ISet<string> exclusiontable)
            : this(_in)
        {
         ...
         */
        public void SetStemmer(MyFrenchStemmer stemmer)
        {
            if (stemmer != null)
            {
        ...
        {
            exclusions = Lucene.Net.Support.Compatibility.SetFactory.CreateHashSet(exclusiontable.Keys);
        }
    }
}
