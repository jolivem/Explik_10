...
namespace Roadkill.Core 
{
    ...
    public class RoadkillSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty("smtpFromEmail", IsRequired = true)]
        public string SmtpFromEmail
        {
            get { return (string)this["smtpFromEmail"]; }
            set { this["smtpFromEmail"] = value; }
        }
        [ConfigurationProperty("smtpFromPwd", IsRequired = true)]
        public string SmtpFromPwd
        {
            get { return (string)this["smtpFromPwd"]; }
            set { this["smtpFromPwd"] = value; }
        }
        [ConfigurationProperty("smtpServerHost", IsRequired = true)]
        public string SmtpServerHost
        {
            get { return (string)this["smtpServerHost"]; }
            set { this["smtpServerHost"] = value; }
        }
