...
namespace Roadkill.Core.Mvc.Attributes
{
    ...
    /// </summary>
    public class ControllerRequiredAttribute : AuthorizeAttribute, ISetterInjected, IAuthorizationAttribute
    {
        [SetterProperty]
        ...
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            return AuthorizationProvider.IsController(principal);
        }
    }
}
