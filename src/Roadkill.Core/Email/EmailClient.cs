...
namespace Roadkill.Core.Email
{
	public class EmailClient : IEmailClient
	{
        ...
        private const string From = "admin@explik.fr";
        //private const string To = "recipient@example.com";
        public EmailClient()
		{

            _smtpClient = new SmtpClient("localhost", 587);
            _smtpClient.DeliveryMethod = SmtpDeliveryMethod.Network;
            _smtpClient.EnableSsl = false;
            //_smtpClient.UseDefaultCredentials = false;
            _smtpClient.Credentials = new System.Net.NetworkCredential("admin@explik.fr", "Vv4ii4?0"); // generated by Ikoula
